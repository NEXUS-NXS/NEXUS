...
- **Backend**: Django REST Framework with SimpleJWT for token-based authentication, extended to use HTTP-only cookies for `access_token` and `refresh_token`. The backend runs on `http://https://nexus-test-api-8bf398f16fc4.herokuapp.com`.
...
- **RegisterView**:
  - Endpoint: `POST http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/register/`
...
- **CustomTokenObtainPairView**:
  - Endpoint: `POST http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/token/`
  - Authenticates via `email` and `password`.
  - Returns user data and sets cookies.
- **ProtectedView**:
  - Endpoint: `GET http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/protected/`
  - Requires authentication (verifies `access_token`).
- **LogoutView**:
  - Endpoint: `POST http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/logout/`
  - Deletes cookies.
- **TokenRefreshView** (SimpleJWT default):
  - Endpoint: `POST http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/token/refresh/`
...
- **CORS**:
  - `CORS_ALLOWED_ORIGINS`: Includes `http://localhost:5173`, `http://https://nexus-test-api-8bf398f16fc4.herokuapp.com`.
...
1. **Frontend**:
   ...
   - Sends POST to `http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/register/` with:
     ```json
     {
       "full_name": "John Doe",
...
1. **Frontend**:
   ...
   - Sends POST to http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/token/ with:
...
- **Method**: **Post**
- **Url**: `http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/register/`
- **Body**:
  ```json
  {
...
- **Method**: **Post**
- **Url**: `http://https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/token/`
- **Body**:
