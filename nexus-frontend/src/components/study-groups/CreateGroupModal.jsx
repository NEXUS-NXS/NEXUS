    ...
    const fetchData = async () => {
      try {
        const [categoriesRes, examFocusRes, tagsRes] = await Promise.all([
          axios.get(
            "https://nexus-test-api-8bf398f16fc4.herokuapp.com/chats/categories/",
            { withCredentials: true }
          ),
          axios.get(
            "https://nexus-test-api-8bf398f16fc4.herokuapp.com/chats/exam-focus/",
            { withCredentials: true }
          ),
          axios.get(
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const csrfToken = await axios
        .get("https://nexus-test-api-8bf398f16fc4.herokuapp.com/auth/csrf/", {
          withCredentials: true,
        })
        .then(() => {
    ...
    <div className="modal-overlay">
      <div className="create-group-modal">
        ...
        <form onSubmit={handleSubmit} className="create-group-form">
          {errors.submit && (
            <span className="error-text form-error">{errors.submit}</span>
          )}
          ...
          <div className="form-group">
            ...
            />
            {errors.max_members && (
              <span className="error-text">{errors.max_members}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.tag_ids && (
              <span className="error-text">{errors.tag_ids}</span>
            )}
          </div>
